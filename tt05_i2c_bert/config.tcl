...
set ::env(VERILOG_FILES) "\
    ...
    $::env(DESIGN_DIR)/dffqn_negedge_async_reset.v \
    $::env(DESIGN_DIR)/dff_async_reset.v \
    $::env(DESIGN_DIR)/glitch_free_clock_mux_async_reset.v \
    $::env(DESIGN_DIR)/sky130_fd_sc_hd__dlrtp.v \
    $::env(DESIGN_DIR)/sky130_fd_sc_hd__maj3.v \
